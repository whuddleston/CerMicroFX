...
dens.space.hrs <- voronoidens %>%
  ...
  geom_point(size = 2, shape = 21, fill = "purple", aes(x = avevoronoix, y = hrs2-nudge, 
                 #size = as.factor(hrs),
                 shape = as.factor(Temp),
                 #color = as.factor(Ni.Vol.Corrected)
                 )) +
  geom_point(size = 2, shape = 22, fill = "red", aes(y = hrs2+nudge, x = fineavennd, #color = as.factor(Ni.Vol.Corrected)
                                         )) +
  geom_point(size = 2, shape = 24, fill = "black", aes(x = countperarea, y = hrs2, 
                 #size = as.factor(hrs),
                 #shape = as.factor(Temp),
                 #color = as.factor(Ni.Vol.Corrected)
                 )) +
  ...
  #
  scale_x_log10(sec.axis = sec_axis(~., name = expression('Counts-Per-Area'~'['*cts*'/'*mu*m^2*']'))) +
...
ggsave(filename = "./paperexports/relspace-cts-hrs-extra.png", plot = extra, device = "png", width = 6,height = 4, units = "in")
...
ggsave(filename = "./paperexports/relspace-cts-hrs-extra2.png", plot = extra2, device = "png", width = 6,height = 6, units = "in")
```
...
ggsave(filename = "./paperexports/relspace-cts-Temp-extra2.png", plot = extra2, device = "png", width = 6,height = 6, units = "in")
```
