...
print(tempyfine)
ggsave(filename = "./plotexports/plotexportyfine.png", plot = tempyfine, 
       device = "png", width = 6,height = 4, units = "in")
rm(tempyfine)
```
...
print(tempPowfine)
ggsave(filename = "./plotexports/plotexportpowfine.png", plot = tempPowfine, 
    device = "png", width = 6,height = 4, units = "in")
rm(tempPowfine)
...
ggsave(filename = "./plotexports/plotexport4fine.png", plot = temp4fine, 
       device = "png", width = 6,height = 4, units = "in")
...
print(tempzzzfine)
ggsave(filename = "./plotexports/plotexportzzzfine.png", plot = tempzzzfine, 
       device = "png", width = 6,height = 4, units = "in")
rm(tempzzzfine)
