...
run("Analyze Particles...", "size=0.001-Infinity display exclude include summarize in_situ");

//selectWindow("Results");
}

//if (nResults==0) exit("Results table is empty"); //saves to directory as cvs file
   path = "/"+replace(getDirectory("current"),"\\","/")+"data-files/"+"PSD.Data.Verbose-edge.csv";
