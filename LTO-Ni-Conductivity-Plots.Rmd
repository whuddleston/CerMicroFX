...
condhrs <- fractSum %>%
  ...
  geom_point(data = condExtra, size = 2, stroke = 2, aes(y = condAve, x = Ni.Vol.Corrected, 
                 ...
                 color = as.factor(hrs))) +
  #
  geom_line(data = condModels, linetype = "dashed", aes(x = Ni.Vol.Corrected, y = seriescond)) +
  geom_line(data = condModels, linetype = "dashed", aes(x = Ni.Vol.Corrected, y = parallcond)) +
  geom_line(data = filter(condModels, disccond < condNi), linetype = "dashed", 
            aes(x = Ni.Vol.Corrected, y = disccond)) +
  #
  geom_line(data = filter(condModels, Ni.Vol.Corrected > nc100), linetype = "dashed", 
...
condtemp <- fractSum %>%
  ...
  #
  geom_line(data = filter(condModels, Ni.Vol.Corrected > nc80), linetype = "dashed", 
