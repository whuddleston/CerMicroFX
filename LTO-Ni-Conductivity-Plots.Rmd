...
print(condhrs2)
ggsave(filename = "./plotexports/plotexportcondhrs2.png", plot = condhrs2, device = "png", width = 8, height = 6, units = "in")
rm(condhrs2)
```
...
print(conex)
ggsave(filename = "./plotexports/plotexportconex.png", plot = conex, device = "png", width = 8, height = 6, units = "in")
rm(conex)
```
