...
temp <- mutate(temp, Ni.Vol.Corrected = as.factor(Ni.Vol.Corrected))
split <- createDataPartition(temp$condAve, p = 0.7, times = 1)
temp <- mutate(temp, Ni.Vol.Corrected = as.numeric(Ni.Vol.Corrected))
...
rfmodel <- trainset %>%
  ...
  select(-Temp, -hrs) %>%
  select(-Ni.Vol.Corrected) %>%
  #select(-totNifrace,-voronoicount,-Th.Density,-finecount) %>%
...
print(conrferrplot)
{if(save == 1)ggsave(filename = "./MLexports/conrferrplot.png", plot = conrferrplot, 
...
print(conrfpredmeas)
{if(save == 1)ggsave(filename = "./MLexports/conrfpredmeas.png", plot = conrfpredmeas, 
         device = "png", width = 6,height = 4, units = "in")}
rm(conrfpredmeas)
...
{if(save == 1)ggsave(filename = "./MLexports/conrfpredmeastrain.png", plot = conrfpredmeas.training, 
         device = "png", width = 6,height = 4, units = "in")}
...
print(conrfmindepth)
{if(save == 1)ggsave(filename = "./MLexports/conrfmindepth.png", plot = conrfmindepth, 
...
print(conrferrplot)
{if(save == 1)ggsave(filename = "./MLexports/ML6/conrferrplot.png", plot = conrferrplot, 
         device = "png", width = 6,height = 4, units = "in")}
rm(conrferr)
rm(conrferrplot)
...
# rm(conrfnode)
{if(save == 1)
png("./MLexports/ML6/conrfnode.png")
print(dotchart(rfmodimp.verb$IncNodePurity, labels = rfmodimp.verb$variable, main = "Conductivity RF"))
dev.off()
}
...
print(conrfpredmeas)
{if(save == 1)ggsave(filename = "./MLexports/ML6/conrfpredmeas.png", plot = conrfpredmeas, 
         device = "png", width = 6,height = 4, units = "in")}
rm(conrfpredmeas)
...
print(conrfpredmeas.training)
{if(save == 1)ggsave(filename = "./MLexports/ML6/conrfpredmeastrain.png", plot = conrfpredmeas.training, 
         device = "png", width = 6,height = 4, units = "in")}
rm(conrfpredmeas.training)
...
print(conrfmindepth)
{if(save == 1)ggsave(filename = "./MLexports/ML6/conrfmindepth.png", plot = conrfmindepth, 
         device = "png", width = 7.29,height = 4.5, units = "in")}
rm(conrfmindepth)
```
...
#                       "% Var Explained"))
# print(consvmvar)
# {if(save == 1)ggsave(filename = "./MLexports/consvmvar.png", plot = consvmvar, 
#          device = "png", width = 6,height = 4, units = "in")}
# rm(consvmvar)
...
{if(save == 1)ggsave(filename = "./MLexports/consvmpredmeas.png", plot = consvmpredmeas, 
         device = "png", width = 6,height = 4, units = "in")}
rm(consvmpredmeas)
```
...
{if(save == 1)ggsave(filename = "./MLexports/stressrferrplot.png", plot = stressrferrplot, 
         device = "png", width = 6,height = 4, units = "in")}
rm(stressrferr)
rm(stressrferrplot)
#print(rfmodels)
...
{if(save == 1)ggsave(filename = "./MLexports/stressrfpredmeas.png", plot = stressrfpredmeas, 
         device = "png", width = 6,height = 4, units = "in")}
rm(stressrfpredmeas)
```
...
# 
# print(stressrfnode)
# {if(save == 1)ggsave(filename = "./MLexports/stressrfnode.png", plot = stressrfnode, 
#          device = "png", width = 6,height = 4, units = "in")}
# rm(stressrfnode)
{if(save == 1)
...
{if(save == 1)ggsave(filename = "./MLexports/stressrfmindepth.png", plot = stressrfmindepth, 
         device = "png", width = 7.29,height = 4.5, units = "in")}
rm(stressrfmindepth)
...
#                       "% Var Explained"))
# print(stress.svmvar)
# {if(save == 1)ggsave(filename = "./MLexports/stress.svmvar.png", plot = stress.svmvar, 
#          device = "png", width = 6,height = 4, units = "in")}
# rm(stress.svmvar)
...
{if(save == 1)ggsave(filename = "./MLexports/stresssvmpredmeas.png", plot = stress.svmpredmeas, 
         device = "png", width = 6,height = 4, units = "in")}
