...
dotchart(rfmodimp.verb$IncNodePurity, labels = rfmodimp.verb$variable, main = "Conductivity RF")
...
ggplot() +
  geom_point(data = consvmimp.verb, aes(x = variable, y = Overall))

dotchart(consvmimp.verb$Overall, labels = consvmimp.verb$variable, main = paste("Conductivity (SVM-Poly.)",
                      svmvarex*100,
                      "% Var Explained"))
...
dotchart(stress.svmimp.verb$Overall, labels = stress.svmimp.verb$variable, main = paste("Stress (SVM-Poly.)",
                      svmvarex*100,
                      "% Var Explained"))
