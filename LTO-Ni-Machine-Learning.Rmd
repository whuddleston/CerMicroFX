...
plot_min_depth_distribution(rfmodel.min.depth.df) +
  xlab("") +
  {if(cb == 1)scale_fill_scico_d(palette = "nuuk", direction = 1, begin = 0, end = 1)}
```
...
plot_min_depth_distribution(rfmodels.min.depth.df) +
  xlab("") +
  {if(cb == 1)scale_fill_scico_d(palette = "nuuk", direction = 1, begin = 0, end = 1)}
```
