...
conrferr <- plot(rfmodel, main = paste("Conductivity Random Forest -", 
                        round(last(rfmodel$rsq)*100,2),
                        "% Var Explained"))

conrferrplot <- ggplot() +
  geom_line(size = 1, aes(x = 1:300, y = conrferr)) +
  labs(title = paste("Conductivity Random Forest - ", 
                        round(last(rfmodel$rsq)*100,2),
                        "% Var Explained", sep = "")) +
  xlab("Trees") +
  ylab("Error") +
...
print(dotchart(consvmimp.verb$Overall, labels = consvmimp.verb$variable, main = paste("Conductivity (SVM-Poly.)",
                                                                                      consvmvarex*100,
                                                                                      "% Var Explained")))
dev.off()
...
stressrferr <- plot(rfmodels, main = paste("Stress Random Forest -", 
                        round(last(rfmodels$rsq)*100,2),
                        "% Var Explained"))

stressrferrplot <- ggplot() +
  geom_line(size = 1, aes(x = 1:300, y = stressrferr)) +
  labs(title = paste("Stress Random Forest - ", 
                        round(last(rfmodels$rsq)*100,2),
                        "% Var Explained", sep = "")) +
  xlab("Trees") +
  ylab("Error") +
...
#          device = "png", width = 6,height = 4, units = "in")
# rm(stress.svmvar)
png("./MLexports/stress.svmvar.png")
print(dotchart(stress.svmimp.verb$Overall, labels = stress.svmimp.verb$variable, main = paste("Stress (SVM-Poly.)",
                                                                                              stress.svmvarex*100,
                                                                                              "% Var Explained")))
dev.off()
...
ggsave(filename = "./MLexports/stress.svmpredmeas.png", plot = stress.svmpredmeas, 
         device = "png", width = 6,height = 4, units = "in")
