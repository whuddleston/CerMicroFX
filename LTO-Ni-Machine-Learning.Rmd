...
trainset.u <- select(trainset, -1,-2,-3,-4,-5,-6, -aveAreafine,
       -totNifrace,
       -Ni.Vol.Corrected, -Temp, -hrs,
       -Th.Density)

testset.u <- select(testset, -1,-2,-3,-4,-5,-6, -aveAreafine,
       -totNifrace,
       -Ni.Vol.Corrected, -Temp, -hrs,
       -Th.Density)
...
trainset.us <- select(trainset2, -1,-2,-3,-4,-5,-6, -aveAreafine,
       -totNifrace,
       -Ni.Vol.Corrected, -Temp, -hrs,
       -Th.Density)

testset.us <- select(testset2, -1,-2,-3,-4,-5,-6, -aveAreafine,
       -totNifrace,
       -Ni.Vol.Corrected, -Temp, -hrs,
       -Th.Density)
