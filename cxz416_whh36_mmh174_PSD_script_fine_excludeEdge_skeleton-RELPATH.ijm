...
saveAs("Results", "/"+replace(getDirectory("current"),"\\","/")+"data-files/"+"skeletons/"+substring(path,start+6,finish)+".csv");

selectWindow("Branch information");

saveAs("Results", "/"+replace(getDirectory("current"),"\\","/")+"data-files/"+"skeleton.branch.info/"+substring(path,start+6,finish)+".csv");
