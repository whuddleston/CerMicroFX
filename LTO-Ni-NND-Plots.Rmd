...
print(nnd_ni)
ggsave(filename = "./plotexports/plotexportnnd_ni.png", plot = nnd_ni, 
...
print(nnd_Temp)
ggsave(filename = "./plotexports/plotexportnnd_Temp.png", plot = nnd_Temp, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_Temp)
...
print(nnd_hrs)
ggsave(filename = "./plotexports/plotexportnnd_hrs.png", plot = nnd_hrs, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_hrs)
```
...
ggsave(filename = "./plotexports/plotexportnnd_ni_700_900.png", plot = nnd_ni_700_900, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_ni_700_900)
...
ggsave(filename = "./plotexports/plotexportnnd_Temp_24_35.png", plot = nnd_Temp_24_35, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_Temp_24_35)
```
...
print(nnd_ni_700)
ggsave(filename = "./plotexports/plotexportnnd_ni_700.png", plot = nnd_ni_700, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_ni_700)
...
print(nnd_Temp_24)
ggsave(filename = "./plotexports/plotexportnnd_Temp_24.png", plot = nnd_Temp_24, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_Temp_24)
...
print(nnd_ni3D_700)
ggsave(filename = "./plotexports/plotexportnnd_ni3D_700.png", plot = nnd_ni3D_700, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_ni3D_700)
...
print(nnd_Temp3D_24)
ggsave(filename = "./plotexports/plotexportnnd_Temp3D_24.png", plot = nnd_Temp3D_24, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_Temp3D_24)
```
...
print(counts_ni)
ggsave(filename = "./plotexports/plotexportcounts_ni.png", plot = counts_ni, 
       device = "png", width = 6,height = 4, units = "in")
rm(counts_ni)
...
print(counts_Temp)
ggsave(filename = "./plotexports/plotexportcounts_Temp.png", plot = counts_Temp, 
       device = "png", width = 6,height = 4, units = "in")
rm(counts_Temp)
...
print(counts_hrs)
ggsave(filename = "./plotexports/plotexportcounts_hrs.png", plot = counts_hrs, 
       device = "png", width = 6,height = 4, units = "in")
rm(counts_hrs)
```
