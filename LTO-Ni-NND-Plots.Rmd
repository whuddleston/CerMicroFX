...
print(ballandstick)
{if(save == 1)ggsave(filename = "./nndexports/plotexportballandstick.png", plot = ballandstick, 
...
print(nnd_ni)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_ni.png", plot = nnd_ni, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_ni)

nnd_Temp <- df_particles_fine %>%
  select(Label, Labelfine, 
...
print(nnd_Temp)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_Temp.png", plot = nnd_Temp, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_Temp)

nnd_hrs <- df_particles_fine %>%
  select(Label, Labelfine, 
...
print(nnd_hrs)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_hrs.png", plot = nnd_hrs, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_hrs)
```
...
```{r}
nnd_ni_700_900 <- df_particles_fine %>%
  select(Label, Labelfine, 
         finecount,countperarea, avennd, fineavennd,
         Ni.Vol.Corrected, Temp, hrs, Th.Density,
         stressf, condAve) %>%
...
print(nnd_ni_700_900)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_ni_700_900.png", plot = nnd_ni_700_900, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_ni_700_900)

nnd_Temp_24_35 <- df_particles_fine %>%
  select(Label, Labelfine, 
         finecount,countperarea, fineavennd,
         Ni.Vol.Corrected, Temp, hrs, Th.Density,
         stressf, condAve) %>%
...
print(nnd_Temp_24_35)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_Temp_24_35.png", plot = nnd_Temp_24_35, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_Temp_24_35)
```

```{r}
nnd_ni_700 <- df_particles_fine %>%
  select(Label, Labelfine, 
         finecount,countperarea, avennd, fineavennd,
         Ni.Vol.Corrected, Temp, hrs, Th.Density,
         stressf, condAve) %>%
...
print(nnd_ni_700)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_ni_700.png", plot = nnd_ni_700, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_ni_700)



nnd_Temp_24 <- df_particles_fine %>%
  select(Label, Labelfine, 
         finecount,countperarea, fineavennd,
         Ni.Vol.Corrected, Temp, hrs, Th.Density,
         stressf, condAve) %>%
...
print(nnd_Temp_24)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_Temp_24.png", plot = nnd_Temp_24, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_Temp_24)


nnd_ni3D_700 <- df_particles_fine %>%
...
print(nnd_ni3D_700)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_ni3D_700.png", plot = nnd_ni3D_700, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_ni3D_700)



nnd_Temp3D_24 <- df_particles_fine %>%
  filter(Label != "WH03A") %>%
  filter(Label != "WH13A") %>%
...
print(nnd_Temp3D_24)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnd_Temp3D_24.png", plot = nnd_Temp3D_24, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nnd_Temp3D_24)
```
...
print(nndtemp3d)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnndtemp3d.png", plot = nndtemp3d, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nndtemp3d)
```
...
nndtime3d <- df_particles_fine %>%
  ...
  mutate(hrs2 = hrs) %>%
  mutate(hrs2 = if_else(hrs == 5, replace(hrs, hrs == 5, 0), hrs2)) %>%
  mutate(hrs2 = if_else(hrs == 10, replace(hrs, hrs == 10, 50), hrs2)) %>%
  mutate(hrs2 = if_else(hrs == 50, replace(hrs, hrs == 50, 100), hrs2)) %>%
  mutate(hrs2 = if_else(hrs == 150, replace(hrs, hrs == 150, 150), hrs2)) %>%
...
print(nndtime3d)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnndtime3d.png", plot = nndtime3d, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nndtime3d)
...
nndni3d <- df_particles_fine %>%
  ...
  mutate(ni2 = Ni.Vol.Corrected) %>%
  mutate(ni2 = if_else(Ni.Vol.Corrected == 0.05,
                                    replace(Ni.Vol.Corrected, Ni.Vol.Corrected == 0.05, 1), ni2)) %>%
  mutate(ni2 = if_else(Ni.Vol.Corrected == 0.10,
                                    replace(Ni.Vol.Corrected, Ni.Vol.Corrected == 0.10, 2), ni2)) %>%
  mutate(ni2 = if_else(Ni.Vol.Corrected == 0.20,
                                    replace(Ni.Vol.Corrected, Ni.Vol.Corrected == 0.20, 3), ni2)) %>%
  mutate(ni2 = if_else(Ni.Vol.Corrected == 0.24,
                                    replace(Ni.Vol.Corrected, Ni.Vol.Corrected == 0.24, 4), ni2)) %>%
  mutate(ni2 = if_else(Ni.Vol.Corrected == 0.28,
                                    replace(Ni.Vol.Corrected, Ni.Vol.Corrected == 0.28, 5), ni2)) %>%
  mutate(ni2 = if_else(Ni.Vol.Corrected == 0.35,
                                    replace(Ni.Vol.Corrected, Ni.Vol.Corrected == 0.35, 6), ni2)) %>%
  mutate(ni2 = if_else(Ni.Vol.Corrected == 0.40,
                                    replace(Ni.Vol.Corrected, Ni.Vol.Corrected == 0.40, 7), ni2)) %>%
  mutate(ni2 = if_else(Ni.Vol.Corrected == 0.50,
                                    replace(Ni.Vol.Corrected, Ni.Vol.Corrected == 0.50, 8), ni2)) %>%
  #
  filter(Area >= 0.005) %>%
  filter(Temp == 900) %>%
  filter(hrs == 5) %>%
...
print(nndni3d)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnndni3d.png", plot = nndni3d, 
       device = "png", width = 6,height = 4, units = "in")}
rm(nndni3d)
...
print(nnddistEDA)
{if(save == 1)ggsave(filename = "./nndexports/plotexportnnddistEDA.png", plot = nnddistEDA, 
...
print(aveR3nnddist)
{if(save == 1)ggsave(filename = "./nndexports/plotexportaveR3nnddist.png", plot = aveR3nnddist, 
       device = "png", width = 10,height = 8, units = "in")}
rm(aveR3nnddist)
```
...
print(counts_ni)
{if(save == 1)ggsave(filename = "./nndexports/plotexportcounts_ni.png", plot = counts_ni, 
       device = "png", width = 6,height = 4, units = "in")}
rm(counts_ni)

counts_Temp <- df_particles_fine %>%
  select(Label, Labelfine, 
         finecount,countperarea,
         Ni.Vol.Corrected, Temp, hrs, Th.Density,
         stressf, condAve) %>%
...
print(counts_Temp)
{if(save == 1)ggsave(filename = "./nndexports/plotexportcounts_Temp.png", plot = counts_Temp, 
       device = "png", width = 6,height = 4, units = "in")}
rm(counts_Temp)

counts_hrs <- df_particles_fine %>%
  select(Label, Labelfine, 
         finecount,countperarea,
         Ni.Vol.Corrected, Temp, hrs, Th.Density,
         stressf, condAve) %>%
...
print(counts_hrs)
{if(save == 1)ggsave(filename = "./nndexports/plotexportcounts_hrs.png", plot = counts_hrs, 
       device = "png", width = 6,height = 4, units = "in")}
rm(counts_hrs)
```
...
{if(save == 1)ggsave(filename = "./nndexports/plotexportcounts_24_35_temp.png", plot = counts_24_35_temp, 
       device = "png", width = 6,height = 4, units = "in")}
...
{if(save == 1)ggsave(filename = "./nndexports/plotexportcounts_700_900_ni.png", plot = counts_700_900, 
       device = "png", width = 6,height = 4, units = "in")}
rm(counts_700_900)
```
