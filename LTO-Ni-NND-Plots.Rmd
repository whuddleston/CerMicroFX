...
print(ballandstick)
ggsave(filename = "./nndexports/plotexportballandstick.png", plot = ballandstick, 
...
print(nnd_ni)
ggsave(filename = "./nndexports/plotexportnnd_ni.png", plot = nnd_ni, 
...
print(nnd_Temp)
ggsave(filename = "./nndexports/plotexportnnd_Temp.png", plot = nnd_Temp, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_Temp)
...
print(nnd_hrs)
ggsave(filename = "./nndexports/plotexportnnd_hrs.png", plot = nnd_hrs, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_hrs)
```
...
ggsave(filename = "./nndexports/plotexportnnd_ni_700_900.png", plot = nnd_ni_700_900, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_ni_700_900)
...
ggsave(filename = "./nndexports/plotexportnnd_Temp_24_35.png", plot = nnd_Temp_24_35, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_Temp_24_35)
```
...
print(nnd_ni_700)
ggsave(filename = "./nndexports/plotexportnnd_ni_700.png", plot = nnd_ni_700, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_ni_700)
...
print(nnd_Temp_24)
ggsave(filename = "./nndexports/plotexportnnd_Temp_24.png", plot = nnd_Temp_24, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_Temp_24)
...
print(nnd_ni3D_700)
ggsave(filename = "./nndexports/plotexportnnd_ni3D_700.png", plot = nnd_ni3D_700, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_ni3D_700)
...
print(nnd_Temp3D_24)
ggsave(filename = "./nndexports/plotexportnnd_Temp3D_24.png", plot = nnd_Temp3D_24, 
       device = "png", width = 6,height = 4, units = "in")
rm(nnd_Temp3D_24)
```
...
print(nndtemp3d)
ggsave(filename = "./nndexports/plotexportnndtemp3d.png", plot = nndtemp3d, 
       device = "png", width = 6,height = 4, units = "in")
rm(nndtemp3d)
```
...
print(nndtime3d)
ggsave(filename = "./nndexports/plotexportnndtime3d.png", plot = nndtime3d, 
       device = "png", width = 6,height = 4, units = "in")
rm(nndtime3d)
...
print(nndni3d)
ggsave(filename = "./nndexports/plotexportnndni3d.png", plot = nndni3d, 
       device = "png", width = 6,height = 4, units = "in")
rm(nndni3d)
...
print(nnddistEDA)
ggsave(filename = "./nndexports/plotexportnnddistEDA.png", plot = nnddistEDA, 
...
print(aveR3nnddist)
ggsave(filename = "./nndexports/plotexportaveR3nnddist.png", plot = aveR3nnddist, 
       device = "png", width = 10,height = 8, units = "in")
rm(aveR3nnddist)
```
...
ggsave(filename = "./nndexports/plotexportpairs.png", plot = fcpairs, 
...
print(counts_ni)
ggsave(filename = "./nndexports/plotexportcounts_ni.png", plot = counts_ni, 
       device = "png", width = 6,height = 4, units = "in")
rm(counts_ni)
...
print(counts_Temp)
ggsave(filename = "./nndexports/plotexportcounts_Temp.png", plot = counts_Temp, 
       device = "png", width = 6,height = 4, units = "in")
rm(counts_Temp)
...
print(counts_hrs)
ggsave(filename = "./nndexports/plotexportcounts_hrs.png", plot = counts_hrs, 
       device = "png", width = 6,height = 4, units = "in")
rm(counts_hrs)
```
...
ggsave(filename = "./nndexports/plotexportcounts_24_35_temp.png", plot = counts_24_35_temp, 
       device = "png", width = 6,height = 4, units = "in")
...
ggsave(filename = "./nndexports/plotexportcounts_700_900_ni.png", plot = counts_700_900, 
       device = "png", width = 6,height = 4, units = "in")
rm(counts_700_900)
```
