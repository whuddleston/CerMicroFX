...
skeleton.data %>%
  ggplot() +
  geom_point(alpha = 0.5, aes(x = Branches, y = Maximum.Branch.Length, 
                 shape = as.factor(hrs),
...
skelematch %>%
  ggplot() +
  geom_point(aes(x = Area, y = Branches, color = as.factor(Ni.Vol.Corrected))) +
...
skelematch %>%
  ggplot() +
  geom_point(alpha = 0.5, aes(x = Area, y = Maximum.Branch.Length, 
                 shape = as.factor(hrs),
                 color = as.factor(Ni.Vol.Corrected))) +
  geom_smooth(method = lm, se = FALSE, aes(group = Labelfine, 
                               color = as.factor(Ni.Vol.Corrected),
...
skelematch %>%
  ggplot() +
  geom_point(alpha = 0.5, aes(x = AR, y = Feret, 
                 shape = as.factor(hrs),
                 color = as.factor(Ni.Vol.Corrected))) +
  geom_smooth(method = lm, se = FALSE, aes(group = Labelfine,
                               color = as.factor(Ni.Vol.Corrected),
