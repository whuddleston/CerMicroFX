...
PCAscree <- fviz_eig(prcomp.R3, addlabels = TRUE) +
  labs(title = "") +
  theme_classic() +
...
prcomp.R3.rot %>%
  ...
  #
  ggplot() +
  geom_tile(aes(x = r3x, y = 1, width = 0.025, height = 0.1, fill = PC1)) +
  geom_tile(aes(x = r3x, y = 2, width = 0.025, height = 0.1, fill = PC2)) +
  geom_tile(aes(x = r3x, y = 3, width = 0.025, height = 0.1, fill = PC3)) +
  geom_tile(aes(x = r3x, y = 4, width = 0.025, height = 0.1, fill = PC4)) +
  geom_tile(aes(x = r3x, y = 5, width = 0.025, height = 0.1, fill = PC5)) +
  #
