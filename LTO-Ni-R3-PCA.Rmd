...
print(PCAscree)
ggsave(filename = "./PCAexports/PCAscree.png", plot = PCAscree, 
...
print(scoresTemp)
ggsave(filename = "./PCAexports/scoresTemp.png", plot = scoresTemp, 
         device = "png", width = 6,height = 4, units = "in")
rm(scoresTemp)
...
print(scoreshrs)
ggsave(filename = "./PCAexports/scoreshrs.png", plot = scoreshrs, 
         device = "png", width = 6,height = 4, units = "in")
rm(scoreshrs)
...
print(scoresNi)
ggsave(filename = "./PCAexports/scoresNi.png", plot = scoresNi, 
         device = "png", width = 6,height = 4, units = "in")
rm(scoresNi)
...
scoresTemphrs <- autoplot(prcomp.R3, 
  ...
  guides(color = guide_legend(reverse = FALSE, title = expression(Temp~'['*degree*C*']'), 
                               ...
                               title.theme = element_text(colour = "black",
                                                          ...
                                                          size = 10)))
print(scoresTemphrs)
ggsave(filename = "./PCAexports/scoresTemphrs.png", plot = scoresTemphrs, 
         device = "png", width = 6,height = 4, units = "in")
rm(scoresTemphrs)
```
...
print(scoresTemp34)
ggsave(filename = "./PCAexports/scoresTemp34.png", plot = scoresTemp34, 
         device = "png", width = 6,height = 4, units = "in")
rm(scoresTemp34)
...
print(scoreshrs34)
ggsave(filename = "./PCAexports/scoreshrs34.png", plot = scoreshrs34, 
         device = "png", width = 6,height = 4, units = "in")
rm(scoreshrs34)
...
print(scoresNi34)
ggsave(filename = "./PCAexports/scoresNi34.png", plot = scoresNi34, 
         device = "png", width = 6,height = 4, units = "in")
rm(scoresNi34)
```
...
print(PCfilm)
ggsave(filename = "./PCAexports/PCfilm.png", plot = PCfilm, 
         device = "png", width = 6,height = 4, units = "in")
rm(PCfilm)
...
print(PCANi)
ggsave(filename = paste("./PCAexports/plotexport",i,"Ni",".png", sep = ""), plot = PCANi, 
         device = "png", width = 6,height = 4, units = "in")
rm(PCANi)
}
...
print(PCAhrs)
ggsave(filename = paste("./PCAexports/plotexport",i,"hrs",".png", sep = ""), plot = PCAhrs, 
         device = "png", width = 6,height = 4, units = "in")
rm(PCAhrs)
}
```
...
for (i in c("PC1","PC2","PC3","PC4","PC5","PC6")) {
  ...
  print(PCATemp)
  ggsave(filename = paste("./PCAexports/plotexport",i,"Temp",".png", sep = ""), plot = PCATemp, 
         device = "png", width = 6,height = 4, units = "in")
  rm(PCATemp)
}
```
...
PCA_Ni_Temp <- r3densities %>%
  ...
  print(PCA_Ni_Temp)
  ggsave(filename = paste("./PCAexports/plotexport",i,"_Ni_Temp",".png", sep = ""), plot = PCA_Ni_Temp, 
         device = "png", width = 6,height = 4, units = "in")
  rm(PCA_Ni_Temp)
...
PCA_Temp_Ni <- r3densities %>%
  ...
  print(PCA_Temp_Ni)
  ggsave(filename = paste("./PCAexports/plotexport",i,"_Temp_Ni",".png", sep = ""), plot = PCA_Temp_Ni, 
         device = "png", width = 6,height = 4, units = "in")
  rm(PCA_Temp_Ni)
}
```
