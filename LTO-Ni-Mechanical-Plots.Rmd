...
print(fracsize2)
ggsave(filename = "./plotexports/plotexportfracsize2.png", plot = fracsize2, 
       device = "png", width = 6,height = 4, units = "in")
rm(fracsize2)
```
...
print(stressnormni2)
ggsave(filename = "./plotexports/plotexportstressnormni2.png", plot = stressnormni2, device = "png", width = 6, height = 4, units = "in")
rm(stressnormni2)
...
ggsave(filename = "./plotexports/plotexportstressnormtemp2.png", plot = stressnormtemp2, device = "png", width = 6, height = 4, units = "in")
rm(stressnormtemp2)
...
ggsave(filename = "./plotexports/plotexportstressnormhrs2.png", plot = stressnormhrs2, 
       device = "png", width = 6, height = 4, units = "in")
rm(stressnormhrs2)
```
...
print(mechhard)
ggsave(filename = "./plotexports/plotexportmechhard.png", plot = mechhard, device = "png", width = 8, height = 6, units = "in")
rm(mechhard)
```
