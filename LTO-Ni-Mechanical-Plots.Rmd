...
{if(save == 1)ggsave(filename = "./mechexports/plotexportmechtempeb.png", plot = mechtempploteb, 
...
print(mechniploteb)
{if(save == 1)ggsave(filename = "./mechexports/plotexportmechnieb.png", plot = mechniploteb, 
       device = "png", width = 6,height = 4, units = "in")}
rm(mechniploteb)
...
print(mechtimeeb)
{if(save == 1)ggsave(filename = "./mechexports/plotexportmechtimeeb.png", plot = mechtimeeb, 
       device = "png", width = 6,height = 4, units = "in")}
rm(mechtimeeb)
```
...
print(fracsize)
{if(save == 1)ggsave(filename = "./mechexports/plotexportfracsize.png", plot = fracsize, 
       device = "png", width = 6,height = 4, units = "in")}
rm(fracsize)
```
...
print(fracsize3)
{if(save == 1)ggsave(filename = "./mechexports/plotexportfracsize3.png", plot = fracsize3, 
       device = "png", width = 6,height = 4, units = "in")}
rm(fracsize3)
...
fracsize2 <- fractSum %>%
  ...
  mutate(stresso = stressf*exp((1.05-Th.Density/100)*coef(fracmodel)[2]*-1)) %>%
  ggplot() +
  geom_point(size = 2.5, stroke = 2,aes(x = R3, y = stresso, 
                 shape = as.factor(hrs),
                 color = as.factor(Temp))) +
  guides(color = FALSE) +
  #scale_x_continuous(sec.axis = sec_axis(~., labels = NULL)) +
...
print(fracsize2)
{if(save == 1)ggsave(filename = "./mechexports/plotexportfracsize2.png", plot = fracsize2, 
       device = "png", width = 6,height = 4, units = "in")}
rm(fracsize2)
```
...
print(fracmod)
{if(save == 1)ggsave(filename = "./mechexports/plotexportfracmod.png", plot = fracmod, 
       device = "png", width = 6,height = 4, units = "in")}
rm(fracmod)
```
...
print(fracporo)
{if(save == 1)ggsave(filename = "./mechexports/plotexportfracporo.png", plot = fracporo, 
       device = "png", width = 6,height = 4, units = "in")}
rm(fracporo)
```
...
print(toughen)
{if(save == 1)ggsave(filename = "./mechexports/plotexportmechtoughen.png", plot = toughen, 
       device = "png", width = 6,height = 4, units = "in")}
rm(toughen)
```
...
print(toughsize)
{if(save == 1)ggsave(filename = "./mechexports/plotexportmechtoughsize.png", plot = toughsize, 
...
print(stressfzz)
{if(save == 1)ggsave(filename = "./mechexports/plotexportstressfzz.png", plot = stressfzz, device = "png", width = 8, height = 6, units = "in")}
rm(stressfzz)
...
print(stressozz)
{if(save == 1)ggsave(filename = "./mechexports/plotexportstressozz.png", plot = stressozz, device = "png", width = 8, height = 6, units = "in")}
rm(stressozz)
```
...
print(stressnormni)
{if(save == 1)ggsave(filename = "./mechexports/plotexportstressnormni.png", plot = stressnormni, device = "png", width = 6, height = 4, units = "in")}
rm(stressnormni)
```

```{r}
stressnormni2 <- fractSum %>%
  filter(is.na(stressf) == FALSE) %>%
  filter(Temp == 900) %>%
  filter(hrs == 5) %>%
  mutate(stresso = stressf*exp((1.05-Th.Density/100)*coef(fracmodel)[2]*-1)) %>%
...
print(stressnormni2)
{if(save == 1)ggsave(filename = "./mechexports/plotexportstressnormni2.png", plot = stressnormni2, device = "png", width = 6, height = 4, units = "in")}
rm(stressnormni2)

stressnormtemp2 <- fractSum %>%
  filter(Ni.Vol.Corrected == 0.35) %>%
  filter(hrs == 5) %>%
  filter(Label != "WH17B") %>%
  filter(Label != "WH06C") %>%
...
print(stressnormtemp2)
{if(save == 1)ggsave(filename = "./mechexports/plotexportstressnormtemp2.png", plot = stressnormtemp2, device = "png", width = 6, height = 4, units = "in")}
rm(stressnormtemp2)

stressnormhrs2 <- fractSum %>%
  filter(Ni.Vol.Corrected == 0.35) %>%
  filter(Temp == 900) %>%
  mutate(stresso = stressf*exp((1.05-Th.Density/100)*coef(fracmodel)[2]*-1)) %>%
  ggplot() +
...
print(stressnormhrs2)
{if(save == 1)ggsave(filename = "./mechexports/plotexportstressnormhrs2.png", plot = stressnormhrs2, 
       device = "png", width = 6, height = 4, units = "in")}
rm(stressnormhrs2)
```
...
{if(save == 1)ggsave(filename = "./mechexports/plotexportstressnormtemp.png", plot = stressnormtemp, device = "png", width = 6, height = 4, units = "in")}
rm(stressnormtemp)
...
print(stressnormhrs)
{if(save == 1)ggsave(filename = "./mechexports/plotexportstressnormhrs.png", plot = stressnormhrs, 
       device = "png", width = 6, height = 4, units = "in")}
rm(stressnormhrs)
...
print(stresscond)
{if(save == 1)ggsave(filename = "./mechexports/plotexportstresscond.png", plot = stresscond, device = "png", width = 8, height = 6, units = "in")}
rm(stresscond)
```
...
{if(save == 1)ggsave(filename = "./mechexports/plotexportnormstresscond.png", plot = normstresscond, device = "png", width = 8, height = 6, units = "in")}
rm(normstresscond)
```

```{r}
mechhard <- read.csv("./data-files/cracklengthdata.csv") %>%
...
print(mechhard)
{if(save == 1)ggsave(filename = "./mechexports/plotexportmechhard.png", plot = mechhard, device = "png", width = 8, height = 6, units = "in")}
rm(mechhard)
```
