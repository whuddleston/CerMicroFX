...
ggsave(filename = "./mechexports/plotexportmechtempeb.png", plot = mechtempploteb, 
...
print(mechniploteb)
ggsave(filename = "./mechexports/plotexportmechnieb.png", plot = mechniploteb, 
       device = "png", width = 6,height = 4, units = "in")
rm(mechniploteb)
...
print(mechtimeeb)
ggsave(filename = "./mechexports/plotexportmechtimeeb.png", plot = mechtimeeb, 
       device = "png", width = 6,height = 4, units = "in")
rm(mechtimeeb)
```
...
print(fracsize)
ggsave(filename = "./mechexports/plotexportfracsize.png", plot = fracsize, 
       device = "png", width = 6,height = 4, units = "in")
rm(fracsize)
```
...
print(fracsize2)
ggsave(filename = "./mechexports/plotexportfracsize2.png", plot = fracsize2, 
       device = "png", width = 6,height = 4, units = "in")
rm(fracsize2)
```
...
print(fracmod)
ggsave(filename = "./mechexports/plotexportfracmod.png", plot = fracmod, 
       device = "png", width = 6,height = 4, units = "in")
rm(fracmod)
```
...
print(fracporo)
ggsave(filename = "./mechexports/plotexportfracporo.png", plot = fracporo, 
       device = "png", width = 6,height = 4, units = "in")
rm(fracporo)
```
...
print(toughen)
ggsave(filename = "./mechexports/plotexportmechtoughen.png", plot = toughen, 
       device = "png", width = 6,height = 4, units = "in")
rm(toughen)
```
...
print(toughsize)
ggsave(filename = "./mechexports/plotexportmechtoughsize.png", plot = toughsize, 
...
print(stressfzz)
ggsave(filename = "./mechexports/plotexportstressfzz.png", plot = stressfzz, device = "png", width = 8, height = 6, units = "in")
rm(stressfzz)
...
print(stressozz)
ggsave(filename = "./mechexports/plotexportstressozz.png", plot = stressozz, device = "png", width = 8, height = 6, units = "in")
rm(stressozz)
```
...
print(stressnormni)
ggsave(filename = "./mechexports/plotexportstressnormni.png", plot = stressnormni, device = "png", width = 6, height = 4, units = "in")
rm(stressnormni)
```
...
print(stressnormni2)
ggsave(filename = "./mechexports/plotexportstressnormni2.png", plot = stressnormni2, device = "png", width = 6, height = 4, units = "in")
rm(stressnormni2)
...
ggsave(filename = "./mechexports/plotexportstressnormtemp2.png", plot = stressnormtemp2, device = "png", width = 6, height = 4, units = "in")
rm(stressnormtemp2)
...
ggsave(filename = "./mechexports/plotexportstressnormhrs2.png", plot = stressnormhrs2, 
       device = "png", width = 6, height = 4, units = "in")
rm(stressnormhrs2)
```
...
ggsave(filename = "./mechexports/plotexportstressnormtemp.png", plot = stressnormtemp, device = "png", width = 6, height = 4, units = "in")
rm(stressnormtemp)
...
print(stressnormhrs)
ggsave(filename = "./mechexports/plotexportstressnormhrs.png", plot = stressnormhrs, 
       device = "png", width = 6, height = 4, units = "in")
rm(stressnormhrs)
...
print(stresscond)
ggsave(filename = "./mechexports/plotexportstresscond.png", plot = stresscond, device = "png", width = 8, height = 6, units = "in")
rm(stresscond)
```
...
ggsave(filename = "./mechexports/plotexportnormstresscond.png", plot = normstresscond, device = "png", width = 8, height = 6, units = "in")
rm(normstresscond)
```
...
print(mechhard)
ggsave(filename = "./mechexports/plotexportmechhard.png", plot = mechhard, device = "png", width = 8, height = 6, units = "in")
rm(mechhard)
```
