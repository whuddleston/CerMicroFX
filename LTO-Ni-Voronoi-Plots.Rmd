...
print(ggvmap)
{if(save == 1)ggsave(filename = "./edgeexports/plotexportggvmap.png", plot = ggvmap, device = "png", width = 8, height = 6, units = "in")}
rm(ggvmap)
```
...
print(ggvmap2)
{if(save == 1)ggsave(filename = "./edgeexports/plotexportggvmap2.png", plot = ggvmap2, device = "png", width = 5, height = 5, units = "in")}
rm(ggvmap2)
```
...
print(voronoiTemp)
{if(save == 1)ggsave(filename = "./edgeexports/voronoiTemp.png", plot = voronoiTemp, 
...
{if(save == 1)ggsave(filename = "./edgeexports/voronoiTempave.png", plot = voronoiTempave, 
    device = "png", width = 6,height = 4, units = "in")}
rm(voronoiTempave)
```
...
{if(save == 1)ggsave(filename = "./edgeexports/voronoiTempcts.png", plot = voronoiTempcts, 
    device = "png", width = 6,height = 4, units = "in")}
rm(voronoiTempcts)
```
...
print(voronoiNi)
{if(save == 1)ggsave(filename = "./edgeexports/voronoiNi.png", plot = voronoiNi, 
    device = "png", width = 6,height = 4, units = "in")}
rm(voronoiNi)
```
...
print(voronoiNiave)
{if(save == 1)ggsave(filename = "./edgeexports/voronoiNiave.png", plot = voronoiNiave, 
    device = "png", width = 6,height = 4, units = "in")}
rm(voronoiNiave)
```
...
print(voronoiNicts)
{if(save == 1)ggsave(filename = "./edgeexports/voronoiNicts.png", plot = voronoiNicts, 
    device = "png", width = 6,height = 4, units = "in")}
rm(voronoiNicts)
```
...
{if(save == 1)ggsave(filename = "./edgeexports/voronoi_Ni_700_900.png", plot = voronoi_Ni_700_900, 
    device = "png", width = 6,height = 4, units = "in")}
...
{if(save == 1)ggsave(filename = "./edgeexports/voronoi_Temp_24_35.png", plot = voronoi_Temp_24_35, 
    device = "png", width = 6,height = 4, units = "in")}
...
print(voronoihrs)
{if(save == 1)ggsave(filename = "./edgeexports/voronoihrs.png", plot = voronoihrs, 
    device = "png", width = 6,height = 4, units = "in")}
rm(voronoihrs)
```
...
print(voronoihrsave)
{if(save == 1)ggsave(filename = "./edgeexports/voronoihrsave.png", plot = voronoihrsave, 
    device = "png", width = 6,height = 4, units = "in")}
rm(voronoihrsave)
```
...
print(voronoihrscts)
{if(save == 1)ggsave(filename = "./edgeexports/voronoihrscts.png", plot = voronoihrscts, 
    device = "png", width = 6,height = 4, units = "in")}
rm(voronoihrscts)
```
...
print(voronoinnd)
{if(save == 1)ggsave(filename = "./edgeexports/voronoinnd.png", plot = voronoinnd, 
    device = "png", width = 6,height = 4.5, units = "in")}
rm(voronoinnd)
```

```{r}
voronoinndtemp <- voronoidens %>%
  select(-x, -count, -density, -Labelfineshort) %>%
  unique() %>%
  #
  #filter(Ni.Vol.Corrected == 0.1) %>%
  ...
  ylab(expression('Edge-to-Edge'~Distance~'['*mu*m*']')) +
  xlab(expression('Center-to-Center'~Distance~'['*mu*m*']')) +
  guides(shape = guide_legend(reverse = TRUE, title = expression(Temp~'['*degree*C*']'), order = 2,
                              title.theme = element_text(colour="black", 
                                                         size = 12))) +
  guides(colour = guide_legend(reverse = TRUE, title = "Ni Vol.", order = 1,
                               #override.aes = list(size=4), 
                               title.theme = element_text(colour = "black",
                                                          #face = "bold",
                                                          size = 12))) +
...
print(voronoinndtemp)
{if(save == 1)ggsave(filename = "./edgeexports/voronoinndtemp.png", plot = voronoinndtemp, 
    device = "png", width = 6,height = 4.5, units = "in")}
rm(voronoinndtemp)
```
...
print(voronoicts)
{if(save == 1)ggsave(filename = "./edgeexports/voronoicts.png", plot = voronoicts, 
    device = "png", width = 6,height = 4.5, units = "in")}
rm(voronoicts)
```

```{r}
voronoictstemp <- voronoidens %>%
  select(-x, -count, -density, -Labelfineshort) %>%
  unique() %>%
  #
  #filter(Ni.Vol.Corrected == 0.35) %>%
...
print(voronoictstemp)
{if(save == 1)ggsave(filename = "./edgeexports/voronoictstemp.png", plot = voronoictstemp, 
    device = "png", width = 6,height = 4.5, units = "in")}
rm(voronoictstemp)
```
...
print(voronoisize)
{if(save == 1)ggsave(filename = "./edgeexports/voronoisize.png", plot = voronoisize, 
    device = "png", width = 6,height = 4.5, units = "in")}
rm(voronoisize)
```

```{r}
voronoisizetemp <- voronoidens %>%
  select(-x, -count, -density, -Labelfineshort) %>%
  unique() %>%
  #
  #filter(Ni.Vol.Corrected == 0.35) %>%
...
print(voronoisizetemp)
{if(save == 1)ggsave(filename = "./edgeexports/voronoisizetemp.png", plot = voronoisizetemp, 
    device = "png", width = 6,height = 4.5, units = "in")}
rm(voronoisizetemp)
```
...
{if(save == 1)ggsave(filename = "./edgeexports/plotexport_con-voronoi-dist-eda.png", plot = con.voronoi.dist.eda, 
